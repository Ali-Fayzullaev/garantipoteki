          ...
          <div className="space-y-8">
            ...
            <Card className="border-0 shadow-2xl bg-white/80 dark:bg-neutral-800/80">
              ...
              <CardContent className="space-y-6">
                {benefits.map((benefit, index) => (
                  <div
                    key={benefit.title}
                    className="flex items-start gap-4 p-4 rounded-2xl bg-gradient-to-r from-blue-500/5 to-green-500/5"
                  >
            ...
            <Card className="border-0 shadow-2xl bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="mt-4 p-4 rounded-xl bg-amber-100 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700">
