          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className="h-12 w-12 rounded-2xl flex items-center justify-center border border-yellow-300">
                <Image src="/logo.png" width={30} height={30} alt="GI" />
              </div>
          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-neutral-200 dark:border-neutral-800">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl border border-yellow-300 flex items-center justify-center">
                    <Image src="/logo.png" width={24} height={24} alt="GI" />
                  </div>
                  <div className="flex flex-col">
              ...
              <nav className="p-6 space-y-4">
                ...
                <div className="items-center gap-2 flex md:hidden  justify-center border-2 rounded-2xl p-2 border-green-200 dark:border-green-800">
                <LanguageToggle />
                <ThemeToggle />
              </div>
              </nav>
              ...
              <div className="absolute bottom-6 left-6 right-6 space-y-3">
                ...
                >
                  ...
                  <span className='text-[14px] md:text-[20px]'>{t.book_consultation_full}</span>
                </Button>
              </div>
            </motion.div>
          </>
